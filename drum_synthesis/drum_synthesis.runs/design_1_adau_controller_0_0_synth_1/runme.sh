...
HD_PWD='C:/Users/Victoria Biliouris/drum_synthesis/drum_synthesis.runs/design_1_adau_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_adau_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_adau_controller_0_0.tcl
