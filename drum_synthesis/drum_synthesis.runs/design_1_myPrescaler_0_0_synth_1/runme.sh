...
HD_PWD='/home/inf2015/vbiliouri/drum_synthesis/drum_synthesis.runs/design_1_myPrescaler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myPrescaler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myPrescaler_0_0.tcl
