...
HD_PWD='c:/drum_synthesis/drum_synthesis.tmp/i2s_data_v1_0_project/i2s_data_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_data_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_data_v1_0.tcl
